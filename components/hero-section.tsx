  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        ...
        {/* Subtitle */}
        <div className="mb-12">
          <p className="font-source-sans text-xl md:text-2xl text-muted-foreground mb-2">Software Engineer</p>
          <p className="font-playfair text-2xl md:text-3xl text-foreground font-bold">Dark Knight of Code</p>
        </div>
